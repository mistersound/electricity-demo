...
import eu.arrowhead.electricity.operator.electricity_common.dto.CategoryRequestDTO;
import eu.arrowhead.electricity.operator.electricity_common.dto.CategoryResponseDTO;
...
public class OperatorMain implements ApplicationRunner {
	...
	private final Logger logger = LogManager.getLogger( OperatorMain.class );
    ...
    public static void main( final String[] args ) {
    	SpringApplication.run(OperatorMain.class, args);
    }
